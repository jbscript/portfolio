...
export default function RootLayout({
  ...
  const classes = "size-4 text-muted-foreground hover:text-foreground transition-colors";
      ...
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased`}>
        <main className="max-w-[1052px] mt-5 mx-auto px-6 lg:px-0">
          <header className="flex justify-center mb-[50px]">
            <nav className="flex items-center gap-x-2" aria-label="Social media links">
